      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* ── Phase Breakdown (everyone sees this) ── */}
            <div className="rounded-xl border border-border bg-panel p-6">
              ...
              {phaseIds.length === 0 ? (
                <p className="text-sm text-muted-text">No phases yet.{isAdmin ? " Add one to start minting." : " Check back soon."}</p>
              ) : (
            ...
            {/* ── Allowlist management (everyone sees this) ── */}
            {phaseIds.length > 0 && (
              <div className="rounded-xl border border-border bg-panel p-6">
            ...
            {/* ── Admin-only: Collection Info editor ── */}
            {isAdmin && (
              <div className="rounded-xl border border-border bg-panel p-6">
  ...
  return (
    <div className="rounded-xl border border-border bg-panel p-6">
      ...
      <p className="text-xs text-muted-text mb-4">
        Once transferred, the creator's wallet will own this collection and manage it directly. This cannot be undone.
      </p>
