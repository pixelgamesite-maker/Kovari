    ...
    <header className="sticky top-0 z-40 border-b border-border bg-background/95 backdrop-blur">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <nav className="hidden items-center gap-6 text-sm text-muted-text md:flex">
          ...
          {isAdmin && <Link href="/launch" className="hover:text-main-text transition-colors">Launch</Link>}
          <Link href="/docs" className="hover:text-main-text transition-colors">Docs</Link>
        </nav>
